...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | If you extend the  NabeelAlalmai\DBcart\Models\Cart class then specify child
    | class namespace here
    |
    */

    'cart_model' => NabeelAlalmai\DBcart\Models\Cart::class,
    ...
    */
    ...
    'cart_line_model' => NabeelAlalmai\DBcart\Models\CartLine::class,
