...
namespace NabeelAlalmai\DBcart\Tests;

use DB;
use DBCart;
use NabeelAlalmai\DBcart\CartServiceProvider;
use NabeelAlalmai\DBCart\Console\Commands\CartCleanup;
...
class CartTest extends \Orchestra\Testbench\TestCase
{
    ...
    {
        return [
            'DBCart' => \NabeelAlalmai\DBcart\Facades\Cart::class
        ];
    }
}
